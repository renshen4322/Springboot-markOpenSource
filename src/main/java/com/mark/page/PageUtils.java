...
public class PageUtils {
     ...
     * @return
     */
    public <T> PageInf<T> executePage(PageRequest page, Supplier<List<T>> supplier) {
     ...
     * @return
     */
    public <T, V> PageInf<V> executePage(PageRequest page, Class<V> targetClass, Supplier<List<T>> supplier) {
    ...
    public <T> PageInf<T> getListPageInfo(PageRequest page, Supplier<List<T>> supplier) {
